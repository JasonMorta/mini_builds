...
export default function IntersectionOP() {
  ...
  const { ref: section4, inView: isVis4 } = useInView({
    threshold: 0,
  });
  ...
  return (
    ...
    <div className='view_box'></div>
      ...
      <p>
        ...
        an element enters or leaves the viewport. Contains both a Hooks, render
        props and plain children implementation.
      </p>
      <section className="text_section">
        ...
        <div ref={section2} className={`contents section2`}>
          {isVis2 ? (
            <>
        ...
        <div
          ref={section3}
          className={`contents  ${isVis3 ? "invert" : "section3"}`}
        >
          <h3>section3</h3>
          <p>
        ...
        <div ref={section4} className="contents  ">
          {isVis4 ? (
        ...
        <div ref={section5} className="contents section5">
          {isVis5 ? (
            <h1
              className="slide-in-elliptic-bottom-fwd "
              style={{ fontSize: "10vw" }}
            >
              END
            </h1>
